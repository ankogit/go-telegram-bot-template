...
import (
	...
	"github.com/ankogit/go-telegram-bot-template/pkg/storage"
	"github.com/ankogit/go-telegram-bot-template/pkg/telegram/jobs"
...
func NewBot(
	...
	return &Bot{bot: bot, config: con, version: version, messages: messages, chatRepository: chatRepository, services: services}
}
